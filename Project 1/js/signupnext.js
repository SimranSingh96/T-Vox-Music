...
var uemail = document.registration.email;
 var reenteremail = document.registration.Re_enter_email;
...
&&(reenteremail.value==''||reenteremail.value==null)&&
(uadd.value==''||uadd.value==null)
&&(uzip.value==''||uzip.value==null))
{
    ...
    // if (passid_validation(passid, 7, 12)) {
      if (allLetter(Firstname)) {
        ...
        if (ValidateEmail(uemail)) {
            if (ValidateReEnterEmail(uemail, reenteremail)) {
